...
import {BillManageUrls} from '../../../service/bill-manage-api/billManageUrl'
    ...
    render() {
        return (
            ...
            <div className="pos-r" style={this.props.location ? {paddingBottom: '2.1rem', minHeight: '100%'} : {}}>
                        ...
                        </li>
                        {
                            ...
                            this.state.fapiao.fp_type == 0
                                ...
                                <li>
                                    <span>特殊开票需求（选填）</span>
                                    <div className="grey t-sm pull-right">
                                        {this.state.fapiao.fapiao_type || '暂无'}
                                    </div>
                                </li>
                            </div>
                        }
                ...
                {
                    this.props.location.state && this.props.location.state.kaipiao
